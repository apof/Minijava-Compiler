...
public class MyStorageVisitor extends GJDepthFirst<Object, Object>{
  ...
  // Ektos ths apothhkeyshs twn aparaithtwn plhroforiwn tsekarw kanw kai tous e3hs elegxous
  // # Na mhn yparxoun klaseis me to idio onoma
  // # H klash apo thn opoia tha klhronomei mia allh na exei oristei parapanw
  // # Na mhn yparxoyn methodoi se mia klash me to idio onoma
  // # Na mhn yparxoun data members me to idio onoma
  // # Na mhn yparxoun orismata synarthshs me to idio onoma
  // # Na mhn yparxoyn topikes metavlhtes synarthshs me to idio onoma
  // # Topika orismenh se synarthsh metavlhth na mhn yparxei san onoma sta orismata ths methodou
  // # Synasrthseis pou klhronomountai apo mia klash se allh kai ginontai overloaded prepei na exoun idio eidos,plhthos orismatwn alla kai typo epistrofhs
  // ginetai elegxos gia oles tis synarthseis ths ierarxias
